  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Toolport Studio prerelease is available for testers."
          : "A new Toolport Studio release is available.",
...
).pipe(Command.withDescription("Post a Toolport Studio release announcement to Discord."));
