...
printf 'Toolport Studio ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
[Console]::Error.WriteLine("Toolport Studio ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
