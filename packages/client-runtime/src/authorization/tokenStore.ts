...
import { RelayManagedEndpoint } from "@toolport-studio/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@toolport-studio/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@toolport-studio/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
