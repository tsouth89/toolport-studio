...
import type { ScopedProjectRef, SidebarProjectGroupingMode } from "@toolport-studio/contracts";
import type { ClientSettings } from "@toolport-studio/contracts/settings";
