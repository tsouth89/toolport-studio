import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@toolport-studio/contracts";
import { resolveRemotePairingTarget } from "@toolport-studio/shared/remote";
...
>()("@toolport-studio/client-runtime/connection/onboarding/ConnectionOnboarding") {}
