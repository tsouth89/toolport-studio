import { AuthStandardClientScopes, EnvironmentId } from "@toolport-studio/contracts";
...
describe("connection onboarding", () => {
  it.effect("prepares a persisted bearer registration from pairing details", () =>
    Effect.gen(function* () {
      ...
      expect(tokenParams.get("client_label")).toBe("Toolport Studio Test");
    }),
  );
