...
export const T3ProjectFileScript = Schema.Struct({
  name: trimmedNonEmpty({
    description: "Display name for the script, shown in the Toolport Studio scripts menu.",
  }),
  command: trimmedNonEmpty({
    description: "Shell command executed in a Toolport Studio terminal at the project root.",
  }),
  ...
  description: "A project script that team members can import into Toolport Studio.",
});
...
export const T3ProjectFile = Schema.Struct({
  ...
  description:
    "Checked-in project configuration for Toolport Studio (t3.json at the repository root). See https://t3.codes for documentation.",
});
