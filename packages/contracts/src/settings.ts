...
export const ClientSettingsSchema = Schema.Struct({
  ...
  verboseActivity: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const BYOK_PRESET_CHOICES: ReadonlyArray<ByokPresetChoice> = [
  ...
  { value: "vercel", label: "Vercel AI Gateway", envKey: "AI_GATEWAY_API_KEY" },
];
...
export const GrokSettings = makeProviderSettingsSchema(
  {
    ...
    homePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom Grok home directory (GROK_HOME). Leave empty for default.",
        providerSettingsForm: { placeholder: "~/.grok", clearWhenEmpty: "omit" },
      }),
    ),
    customModels: Schema.Array(Schema.String).pipe(
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  verboseActivity: Schema.optionalKey(Schema.Boolean),
