...
>()("@toolport-studio/contracts/relay/RelayClientPrincipal") {}
...
>()("@toolport-studio/contracts/relay/RelayEnvironmentPrincipal") {}
...
export const RelayApi = HttpApi.make("RelayApi")
  ...
  .annotate(OpenApi.Title, "Toolport Studio Relay API")
