...
export const DESKTOP_PRODUCTION_SCHEME = "toolport-studio";
export const DESKTOP_DEVELOPMENT_SCHEME = "toolport-studio-dev";
...
>()("@toolport-studio/desktop/electron/ElectronProtocol") {}
