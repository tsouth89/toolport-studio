...
import type { DesktopUpdateState } from "@toolport-studio/contracts";
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          TOOLPORT_STUDIO_HOME: `/tmp/t3-desktop-updates-test-${process.pid}`,
          TOOLPORT_STUDIO_DESKTOP_MOCK_UPDATES: "true",
          TOOLPORT_STUDIO_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
