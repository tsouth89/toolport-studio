import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@toolport-studio/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@toolport-studio/shared/observability";
...
>()("@toolport-studio/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
