...
>()("@toolport-studio/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Toolport Studio";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(configuredBaseDir, () =>
    path.join(homeDirectory, ".toolport-studio"),
  );
  ...
  const userDataDirName = isDevelopment ? "toolport-studio-dev" : "toolport-studio";
  const legacyUserDataDirName = isDevelopment ? "Toolport Studio (Dev)" : "Toolport Studio (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "studio.toolport.desktop.dev" : "studio.toolport.desktop",
    ),
    linuxDesktopEntryName: isDevelopment
      ? "toolport-studio-dev.desktop"
      : "toolport-studio.desktop",
    linuxWmClass: isDevelopment ? "toolport-studio-dev" : "toolport-studio",
    userDataDirName,
