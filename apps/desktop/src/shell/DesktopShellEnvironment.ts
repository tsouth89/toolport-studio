...
>()("@toolport-studio/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__TOOLPORT_STUDIO_ENV_${name}_START__`;
const endMarker = (name: string) => `__TOOLPORT_STUDIO_ENV_${name}_END__`;
