...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/Toolport Studio (Dev).app",
      "Toolport Studio (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "Toolport Studio (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Toolport Studio (Dev).app/Contents/MacOS/Toolport Studio (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Toolport Studio (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/Toolport Studio (Dev).app/Contents/MacOS/Electron'",
    );
