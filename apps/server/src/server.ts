import { EnvironmentHttpApi } from "@toolport-studio/contracts";
...
import { disableTailscaleServe, ensureTailscaleServe } from "@toolport-studio/tailscale";
      ...
      Effect.gen(function* () {
        ...
        yield* Effect.forkScoped(
          Effect.sleep("250 millis").pipe(
            ...
            Effect.tap(() => Effect.logInfo("Toolport Connect desired link reconciled on startup")),
            Effect.catch((cause) =>
              Effect.logWarning("Failed to reconcile Toolport Connect desired link on startup", {
                cause,
              }),
            ),
          ),
