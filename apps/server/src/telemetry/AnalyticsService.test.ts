    ...
    Effect.gen(function* () {
      ...
      const configLayer = ConfigProvider.layer(
        ConfigProvider.fromUnknown({
          TOOLPORT_STUDIO_TELEMETRY_ENABLED: true,
          TOOLPORT_STUDIO_POSTHOG_KEY: "phc_test_key",
          TOOLPORT_STUDIO_POSTHOG_HOST: "",
          TOOLPORT_STUDIO_TELEMETRY_FLUSH_BATCH_SIZE: 20,
        }),
      );
