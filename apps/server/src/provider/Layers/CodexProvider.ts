...
import { PREFERRED_DEFAULT_CODEX_MODELS, ServerSettingsError } from "@toolport-studio/contracts";
    ...
    if (!codexSettings.enabled) {
      return buildServerProvider({
        ...
        probe: {
          ...
          status: "warning",
          auth: { status: "unknown" },
          message: "Codex is disabled in Toolport Studio settings.",
        },
      });
    }
