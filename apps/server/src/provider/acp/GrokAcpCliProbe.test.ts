 ...
 * Enable with: TOOLPORT_STUDIO_GROK_ACP_PROBE=1 bun run test GrokAcpCliProbe
 *
...
describe.runIf(process.env.TOOLPORT_STUDIO_GROK_ACP_PROBE === "1")("Grok ACP CLI probe", () => {
