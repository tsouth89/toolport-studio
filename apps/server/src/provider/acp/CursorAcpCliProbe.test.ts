 ...
 * Enable with: TOOLPORT_STUDIO_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.TOOLPORT_STUDIO_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
