...
import type { RelayClientEnvironmentRecord } from "@toolport-studio/contracts/relay";
...
/**
 * The user's Toolport Connect environments from relay discovery, each with a
  ...
  const connectEnvironment = async (environment: RelayClientEnvironmentRecord) => {
    ...
    if (result._tag === "Success") {
      toastManager.add({
        ...
        description: `Connecting to ${environment.label} through Toolport Connect.`,
      });
      return;
    }
    ...
    const message =
      cause instanceof Error
        ? cause.message
        : "Could not connect the Toolport Connect environment.";
      ...
      return (
        <div className={ITEM_ROW_CLASSNAME}>
          <p className="text-sm font-medium text-destructive">
            Could not load Toolport Connect environments
          </p>
