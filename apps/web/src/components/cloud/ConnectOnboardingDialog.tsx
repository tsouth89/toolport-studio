...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@toolport-studio/contracts";
...
/**
 * Post-sign-in onboarding wizard for Toolport Connect. Opens on every in-session
 ...
 * account's Toolport Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "Toolport Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Toolport Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Toolport Connect."
