...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY =
  "toolport-studio:version-mismatch-dismissals:v1";
...
export function serverUpdateGuidance(
  ...
  switch (capability) {
    ...
    case "desktop-managed":
      return `The ${serverLabel} is run by the Toolport Studio desktop app on its machine — update the desktop app there to sync them.`;
    default:
