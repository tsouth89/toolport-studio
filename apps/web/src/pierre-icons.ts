...
const PIERRE_ICON_SPRITE_ID = "toolport-studio-pierre-file-icon-sprite";

const TOOLPORT_STUDIO_FILE_ICON_SPRITE = `
...
export const TOOLPORT_STUDIO_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: TOOLPORT_STUDIO_FILE_ICON_SPRITE,
  byFileName: {
...
const completeIconResolver = createFileTreeIconResolver(TOOLPORT_STUDIO_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${TOOLPORT_STUDIO_FILE_ICON_SPRITE}`;
