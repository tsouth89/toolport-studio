...
import { canSettle, canSnooze } from "@toolport-studio/client-runtime/state/thread-settled";
import { EnvironmentId, type ScopedThreadRef, ThreadId } from "@toolport-studio/contracts";
...
export function useThreadActions() {
  ...
  const unsettleThread = useCallback(
    async (target: ScopedThreadRef) => {
      ...
      // reason "user" pins the thread active: inactivity auto-settle stays
      // suppressed until real activity clears the pin.
